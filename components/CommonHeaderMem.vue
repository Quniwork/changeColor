<template>
  <div class="member-wrap">
    <div class="login-wrap" v-if="!mainStore.isLoggedIn">
...
const updateFilteredLinks = () => {
  ...
  switch (true) {
    case currentPath === 'first':
      filteredLinks.value = mainStore.apiData.meminfoLinks.first || [];
      break;
    case currentPath === 'ball':
      filteredLinks.value = mainStore.apiData.meminfoLinks.ball || [];
      break;
    default:
      filteredLinks.value = mainStore.apiData.meminfoLinks.else || [];
  }
};
...
const handleLogin = () => {
  if (username.value && password.value) {
    mainStore.updateLoginStatus(true);
  }
};

const handleLogout = () => {
  mainStore.updateLoginStatus(false);
};
